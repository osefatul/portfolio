...
function OtherProjects() {
    ...
    useEffect(()=>{
        const fetchData = async ()=>{
            ...
            setSplitUrlData(res.data.map(data => {
                const splitHtml = data.html_url.split('/');
                return splitHtml[splitHtml.length - 1]
            }))
    ...
    <div
    id="githubProjects" 
    className=' text-white mx-auto flex flex-col md:items-center justify-start 2xl:justify-center relative w-[100%] sm:w-[90%] md:w-[80%] h-almost pb-40 '>
